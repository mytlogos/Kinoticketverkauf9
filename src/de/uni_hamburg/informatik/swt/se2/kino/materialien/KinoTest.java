...
public class KinoTest
{
    ...
    public void setUp()
    {
        ...
        _vorstellungSaal1Film0 = new Vorstellung(_saal1, _film0, _u1, _u2, _d1, Geldbetrag.get(900));
        _vorstellungSaal2Film1 = new Vorstellung(_saal2, _film1, _u1, _u2, _d1, Geldbetrag.get(1000));
